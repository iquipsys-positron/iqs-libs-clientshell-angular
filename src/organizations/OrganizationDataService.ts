import {
    IShellOrganizationDataService,
    IShellOrganizationDataProvider
} from './IOrganizationDataService';
import {
    Organization
} from './Organization';
import {
...
class OrganizationData implements IShellOrganizationDataService {
...
class OrganizationDataProvider implements IShellOrganizationDataProvider {
    private _service: IShellOrganizationDataService;
    ...
    public $get(
        ...
        if (this._service == null) {
            this._service = new OrganizationData(pipRest, pipFormat, $http);
        }
...
angular
    .module('iqsShellOrganizationData', ['pipRest', 'pipServices'])
    .provider('iqsShellOrganizationData', OrganizationDataProvider);