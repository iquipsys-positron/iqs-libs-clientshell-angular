...
interface StringConstructor {
    ...
    /**
      ...
      * as such the first argument will be a well formed template call organization object and the rest
      * parameter will contain the substitution values.
      * @param template A well-formed template string call organization representation.
