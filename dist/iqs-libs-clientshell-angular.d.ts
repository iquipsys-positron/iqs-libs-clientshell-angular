...
export class HelpArticleContent {
    language: string;
    title: string;
    content?: pip.composite.ContentBlock[];
}
...
export interface IOrganizationsDataService {
    ...
    findOrganizationByCode(code: string, successCallback?: (data: any) => void, errorCallback?: (error: any) => void): any;
    validateCode(code: string, successCallback?: (data: any) => void, errorCallback?: (error: any) => void): any;
...
export const userRoleValue: {
    ...
    [UserRole.org_admin]: number;
    [UserRole.admin]: number;
    [UserRole.unknown]: number;
};
...
export class AccountsModel {
    ...
    updateAccount(data: Account, callback?: (item: any) => void, errorCallback?: (err: any) => void): void;
    clean(): void;
}
...
export class DataProfilesModel {
    ...
    private getDataProfilesCallback;
    getTransaction(): pip.services.Transaction;
    clean(): void;
}
...
export class DevicesModel {
    ...
    private onUpdateDevice;
    updateDevice(data: Device, callback?: (item: any) => void, errorCallback?: (err: any) => void): void;
    verifyDeviceUdi(params: any, successCallback?: (data: any) => void, errorCallback?: (error: any) => void): void;
    getTransaction(): pip.services.Transaction;
    clean(): void;
}
...
export class EventRuleCalculator {
    ...
    private getLabelPressedEventRule;
    private getLabelLongPressedEventRule;
    private getLabelMaxSpeedLimitEventRule;
    private getLabelMinSpeedLimitEventRule;
    private getLabelImmobilityEventRule;
    private getLabelPresenceEventRule;
    private getLabelShowUpEventRule;
    private getLabelDisappearEventRule;
...
export class EventRulesModel {
    ...
    private objectsToString;
    private accountsToString;
...
export class GuidesModel {
    ...
    private markView;
    private getLastReleaseGuide;
    private getLastIntroGuide;
    private getHelpGuide;
    private getLastGuide;
...
export class IncidentsModel {
    ...
    getIncidentDetails(incident: any): string;
    clean(): void;
    private filterIncidentBySettings;
    reCalcElapsedDate(): void;
    private calcElapsedDate;
}
...
export interface IObjectsViewModel {
    ...
    updateObject(data: ControlObject, callback?: (item: any) => void, errorCallback?: (err: any) => void): any;
    getTransaction(): pip.services.Transaction;
...
export class ObjectsModel {
    ...
    updateObject(data: ControlObject, callback?: (item: any) => void, errorCallback?: (err: any) => void): void;
    clean(): void;
}
...
export class ObjectRoutesModel {
    ...
    private getFromTime;
    private convertCurrentObjectPositions;
    private takeCurrRoute;
    private takeHistoryRoutes;
    private setLastRouteTime;
    private reloadRoute;
    private insertCurrentPosition;
    private insertCurrentPoints;
    private filterPositions;
    private extractObjectId;
    private createPositions;
    private filteredOldPositions;
    private updatePositions;
    private getCurrentObjectRoute;
    private getAllObjectRoutes;
...
export class ObjectsRoutesModel {
    ...
    private getStartTime;
    private getRouteObjectIndex;
    private convertObjectPositions;
    private takeCurrRoutes;
    private takeHistoryRoutes;
    private filterPositions;
    private getRouteObjectId;
    private getLastTime;
    private createPositions;
    ...
    private updateObjectsHead;
    private setCenter;
    private setHighlightsCenter;
    private getLastPosition;
    private getCompressing;
    private selectById;
    private setAutoZoom;
...
export class RouteVisualization {
    ...
    private static takeLastTime;
    private static takeFirstTime;
    private static isEquivPosition;
    private static checkCuttInterval;
    private static updateStopStopPath;
    private static updateStopTravelPath;
    private static updateTravelStopPath;
    private static updateTravelTravelPath;
...
export class OperationalEventsModel {
    ...
    search: string;
    filter: any;
    private getOperationalEventDetails;
...
export class ShiftsModel {
    ...
    updateShift(data: Shift, callback?: (item: any) => void, errorCallback?: (err: any) => void): void;
    selectItem(index?: number): void;
    clean(): void;
}
...
export class ZonesModel {
    ...
    private convertCenter;
    private convertZonePositions;
    private updateMapZones;
    private prepare;
    private prepareZone;
    private updateItemInCollection;
    private collectionChanged;
